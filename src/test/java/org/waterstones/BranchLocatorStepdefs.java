...
public class BranchLocatorStepdefs {
    ...
    public void theSearchResultsForThatCityAreDisplayed() {
        Assert.assertTrue(Hooks.androidDriver.findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.waterstones.app:id/text_shop\" and @text=\"London - Greenwich\"]")).isDisplayed());
    }
